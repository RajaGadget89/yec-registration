...
// Mock magic link URL for testing (no real credentials)
const REAL_MAGIC_LINK_URL = "http://localhost:8080/auth/callback#access_token=mock_access_token&expires_at=1754930539&expires_in=3600&refresh_token=mock_refresh_token&token_type=bearer&type=magiclink";

// Test data (using mock values)
const TEST_ADMIN_EMAIL = 'test-admin@example.com';
const TEST_ACCESS_TOKEN = 'mock_access_token_for_testing';
const TEST_REFRESH_TOKEN = 'mock_refresh_token_for_testing';
