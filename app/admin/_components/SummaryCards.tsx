      ...
      {cards.map((card) => {
        ...
        return (
          ...
          >
            ...
            {/* Border gradient */}
            <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${card.borderGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-baseline space-x-2">
                    ...
                    {filteredTotal && filteredTotal !== totalRegistrations && card.title === 'Total Registrations' && (
                ...
                <div className={`relative p-3 rounded-2xl bg-gradient-to-br ${card.gradient} shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300`}>
              ...
              {/* Progress indicator */}
              {card.title === 'Total Registrations' && totalRegistrations > 0 && (
                <div className="mt-4">
                  <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400 mb-1">
                    <span>Registration Progress</span>
                    <span className="font-medium">{Math.round((approvedCount / totalRegistrations) * 100)}%</span>
                  </div>
                  <div className="w-full bg-gray-200/50 dark:bg-gray-700/50 rounded-full h-2 overflow-hidden backdrop-blur-sm">
                    <div 
                      ...
                      style={{ width: `${(approvedCount / totalRegistrations) * 100}%` }}
                    ></div>
                  </div>
                </div>
              )}
