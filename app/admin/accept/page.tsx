...
type AcceptState = 'loading' | 'success' | 'expired' | 'used' | 'revoked' | 'invalid' | 'error';
...
export default function AcceptInvitationPage() {
  ...
  const acceptInvitation = async (token: string) => {
    try {
      ...
      const response = await fetch(`/api/admin/management/invitations/${token}/accept`, {
        method: 'POST',
        headers: {
  ...
  const handleRequestNewInvite = () => {
    ...
    window.location.href = 'mailto:info@yecday.com?subject=Request for Admin Invitation';
  };
      ...
      case 'success':
        return (
          <div className="text-center" data-testid="success-state">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Welcome to YEC Day Admin Console!</h2>
            <p className="text-gray-600 mb-6">
              Your invitation has been accepted successfully. You are now an administrator.
            </p>
            <button
      ...
      case 'expired':
        return (
          <div className="text-center" data-testid="expired-state">
            ...
            <p className="text-gray-600 mb-6">
              This invitation has expired. Invitations are valid for 48 hours from the time they are sent.
            </p>
            <button
      ...
      case 'used':
        return (
          <div className="text-center" data-testid="used-state">
            ...
            <p className="text-gray-600 mb-6">
              This invitation has already been accepted. Each invitation can only be used once.
            </p>
            <button
              onClick={handleRequestNewInvite}
              className="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors"
      ...
      case 'revoked':
        return (
          <div className="text-center" data-testid="revoked-state">
            ...
            <p className="text-gray-600 mb-6">
              This invitation has been revoked by an administrator and is no longer valid.
            </p>
            <button
              onClick={handleRequestNewInvite}
              className="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors"
      ...
      case 'error':
        return (
          <div className="text-center" data-testid="error-state">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Error Processing Invitation</h2>
            <p className="text-gray-600 mb-6">
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">YEC Day Admin Console</h1>
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-500">
          ...
          <a href="mailto:info@yecday.com" className="text-blue-600 hover:text-blue-500">
            info@yecday.com
          </a>
        </p>
      </div>
