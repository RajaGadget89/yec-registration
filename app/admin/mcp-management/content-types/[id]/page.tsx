...
import EditContentTypeClient from "./EditContentTypeClient";

export const metadata: Metadata = {
  title: "Edit Content Type - MCP Management",
  description: "Edit MCP content type configuration",
};
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Modify MCP content type configuration
          </p>
        </div>
      </div>

      <EditContentTypeClient contentTypeId={id} />
    </div>
  );
}
