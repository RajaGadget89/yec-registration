...
import NewContentTypeClient from "./NewContentTypeClient";

export const metadata: Metadata = {
  title: "Create Content Type - MCP Management",
  description: "Add a new content type to the MCP system",
};
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Add a new content type to the MCP system
          </p>
        </div>
      </div>

      <NewContentTypeClient />
    </div>
  );
}
