...
export async function GET(
  req: NextRequest,
  { params }: { params: { registration_id: string; event_id: string } }
) {
  ...
  try {
    ...
    const alreadyCheckedIn = event.event_types.business_rule_category === 'ONE_TIME_ONLY' 
    ...
    return NextResponse.json({
      ...
      isEventTypeRestricted: event.event_types.business_rule_category === 'ONE_TIME_ONLY',
