...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('[TEST-TELEGRAM] Global telegramOutbox length:', global.telegramOutbox?.length || 0);
    console.log('[TEST-TELEGRAM] Global telegramOutbox:', global.telegramOutbox);
