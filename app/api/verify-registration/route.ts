    ...
    return new Response(
      JSON.stringify({ 
        ...
        registration: {
          ...
          email_sent_at_thailand: latestRegistration.email_sent_at ? formatThailandTime(latestRegistration.email_sent_at) : null,
          created_at: latestRegistration.created_at,
          created_at_thailand: formatThailandTime(latestRegistration.created_at),
          updated_at: latestRegistration.updated_at,
          updated_at_thailand: formatThailandTime(latestRegistration.updated_at),
