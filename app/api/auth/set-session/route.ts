...
export async function POST(req: Request) {
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          message: "Session set but user verification failed",
        },
        { status: 500 },
      );
    }
    ...
    const errorMessage =
      e instanceof Error ? e.message : "Failed to set session";
    return NextResponse.json(
