...
export const formSchema: FormField[] = [
    ...
    validation: {
      ...
      customValidation: (value: string) => {
        ...
        if (!/^[a-zA-Z0-9._-]+$/.test(value))
          return "Line ID ต้องเป็นภาษาอังกฤษเท่านั้น";
        return null;
      },
    },
  },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "out-of-quota", label: "รถตู้บริการรับส่งถึงโรงแรม" },
    ...
    roommatePhoneField: {
      ...
      validation: {
        ...
        customValidation: (value: string) => {
          ...
          if (!/^0\d{9}$/.test(value))
            return "เบอร์โทรผู้ร่วมพักต้องขึ้นต้นด้วย 0 และมี 10 หลัก";
          return null;
        },
      },
    },
  },
  {
    ...
    type: "select",
    label: "รายชื่อโรงแรมแนะนำ มีบริการรับส่ง",
    required: true,
    dependsOn: {
      field: "hotelChoice",
      value: "out-of-quota",
    ...
    options: [
      { value: "โรงแรมหาดใหญ่ มิตรทาวน์", label: "โรงแรมหาดใหญ่ มิตรทาวน์" },
      { value: "โรงแรมบุรีศรีภู", label: "โรงแรมบุรีศรีภู" },
      { value: "โรงแรมม่อนคำ", label: "โรงแรมม่อนคำ" },
      { value: "โรงแรมคริสตัล", label: "โรงแรมคริสตัล" },
      { value: "โรงแรมทีอาร์ร็อคฮิล", label: "โรงแรมทีอาร์ร็อคฮิล" },
      { value: "โรงแรมนิวซีซั่น", label: "โรงแรมนิวซีซั่น" },
      { value: "โรงแรม Z Sleep", label: "โรงแรม Z Sleep" },
      { value: "โรงแรม Smart Hotel", label: "โรงแรม Smart Hotel" },
    ],
  },
  {
    id: "travelType",
