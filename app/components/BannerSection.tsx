      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover the exciting lineup of activities and networking
            opportunities planned for YEC Day
          </p>
        </header>
        ...
        >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold text-yec-primary mb-3 group-hover:text-yec-accent transition-colors duration-300">
                ...
                <span className="sr-only">
                  Theater masks emoji representing
                </span>{" "}
                Culture
              </h3>
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                Immerse yourself in the rich cultural heritage and traditions
                while building meaningful relationships with diverse
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold text-yec-primary mb-3 group-hover:text-yec-accent transition-colors duration-300">
                ...
                <span className="sr-only">Link emoji representing</span>{" "}
                Connection
              </h3>
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                Build strong professional relationships and connect with
                like-minded entrepreneurs who share your vision and passion for
                business success.
              </p>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold text-yec-primary mb-3 group-hover:text-yec-accent transition-colors duration-300">
                <span className="inline-block animate-ping" aria-hidden="true">
                  🤝
                </span>
                <span className="sr-only">Handshake emoji representing</span>{" "}
                Collaboration
              </h3>
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                Work together with fellow entrepreneurs to create innovative
                solutions and partnerships that drive mutual success and
                business growth.
              </p>
