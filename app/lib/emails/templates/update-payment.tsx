      ...
      content={
        <div>
          <p>
            ...
            และต้องการให้คุณอัปเดตสลิปโอนเงิน | Thank you for registering for
            YEC Day! We have reviewed your registration and need you to update
            your payment slip.
          </p>
          ...
          <p>
            กรุณาคลิกปุ่มด้านล่างเพื่ออัปเดตสลิปโอนเงินของคุณ | Please click the
            button below to update your payment slip.
          </p>
        </div>
      }
      ctaButton={
