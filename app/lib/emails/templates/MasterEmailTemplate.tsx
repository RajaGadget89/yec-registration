...
export const MasterEmailTemplate: React.FC<MasterEmailTemplateProps> = ({
  ...
  const highlightColor = brandTokens?.highlightColor || colors.highlight;
  ...
  const getButtonStyle = (color: string = "primary") => {
    ...
    return {
      backgroundColor: buttonColors[color as keyof typeof buttonColors] || primaryColor,
      color: "#ffffff",
      padding: "14px 28px",
      borderRadius: "8px",
      textDecoration: "none",
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", margin: 0, padding: 0 }}>
      {/* Email Container */}
      <div style={{ 
        maxWidth: "600px", 
        margin: "0 auto", 
        ...
        <div style={{ padding: "32px 24px" }}>
          ...
          {ctaButton && (
            <div style={{
              ...
              <a
                href={ctaButton.url}
                style={getButtonStyle(ctaButton.color)}
              >
                {ctaButton.text}
              </a>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ margin: 0 }}>
              YEC Day - Young Entrepreneurs Chamber
            </p>
            <p style={{ margin: "4px 0 0 0" }}>
              This email was sent to {applicantName} regarding their YEC Day registration.
            </p>
          </div>
        </div>
