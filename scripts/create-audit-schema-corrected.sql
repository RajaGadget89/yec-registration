...
-- CORRECTED VERSION: Handles actor_id UUID type and function conflicts
...
-- Create audit.event_log table with actor_id as TEXT (not UUID)
CREATE TABLE audit.event_log (
    ...
    resource_id TEXT,
    actor_id TEXT,  -- Keep as TEXT to match our function expectations
...
BEGIN
    INSERT INTO audit.event_log (
        ...
        p->>'resource',
        p->>'resource_id',
        p->>'actor_id',  -- This will be TEXT, matching our table definition
        p->>'actor_role',
        p->>'result',
        p->>'reason',
        p->>'correlation_id',
