...
\restrict gNnIAY8Nd0zDy5ifBIYNawa3PPvk6JzGA5cZgstQ7EdmKrOCJOEwuzxrDaZkTkf
...
--
-- Name: log_access("jsonb"); Type: FUNCTION; Schema: audit; Owner: -
--

CREATE FUNCTION "audit"."log_access"("p" "jsonb") RETURNS "void"
...
--
-- Name: log_event("jsonb"); Type: FUNCTION; Schema: audit; Owner: -
--

CREATE FUNCTION "audit"."log_event"("p" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: now_utc(); Type: FUNCTION; Schema: ops; Owner: -
--

CREATE FUNCTION "ops"."now_utc"() RETURNS timestamp with time zone
    LANGUAGE "sql" STABLE
    AS $$
...
--
-- Name: purge_old_logs(integer); Type: FUNCTION; Schema: ops; Owner: -
--

CREATE FUNCTION "ops"."purge_old_logs"("retention_days" integer DEFAULT 90) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
--
-- Name: get_price_packages(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."get_price_packages"() RETURNS TABLE("code" "text", "name" "text", "currency" "text", "early_bird_amount" numeric, "regular_amount" numeric, "is_early_bird" boolean)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: get_registration_statistics(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."get_registration_statistics"() RETURNS TABLE("total_count" bigint, "waiting_for_review_count" bigint, "waiting_for_update_payment_count" bigint, "waiting_for_update_info_count" bigint, "waiting_for_update_tcc_count" bigint, "approved_count" bigint, "rejected_count" bigint)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: is_registration_open(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."is_registration_open"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  event_setting RECORD;
...
--
-- Name: query_access_logs_by_request_id("text", timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."query_access_logs_by_request_id"("request_id_param" "text", "cutoff_time_param" timestamp with time zone) RETURNS TABLE("id" bigint, "occurred_at_utc" timestamp with time zone, "action" "text", "resource" "text", "result" "text", "request_id" "text", "meta" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: query_recent_access_logs(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."query_recent_access_logs"("cutoff_time_param" timestamp with time zone) RETURNS TABLE("id" bigint, "occurred_at_utc" timestamp with time zone, "action" "text", "resource" "text", "result" "text", "request_id" "text", "meta" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: query_recent_event_logs(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."query_recent_event_logs"("cutoff_time_param" timestamp with time zone) RETURNS TABLE("id" bigint, "occurred_at_utc" timestamp with time zone, "action" "text", "resource" "text", "resource_id" "text", "actor_role" "text", "result" "text", "reason" "text", "correlation_id" "text", "meta" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: registration_sweep(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."registration_sweep"() RETURNS TABLE("registration_id" "text", "action" "text", "reason" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  event_setting RECORD;
...
--
-- Name: update_registration_review_status("text", "text", "text"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."update_registration_review_status"("registration_id_param" "text", "track_param" "text", "status_param" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: access_log_id_seq; Type: SEQUENCE; Schema: audit; Owner: -
--
...
--
-- Name: access_log_id_seq; Type: SEQUENCE OWNED BY; Schema: audit; Owner: -
--
...
--
-- Name: event_log; Type: TABLE; Schema: audit; Owner: -
--
...
--
-- Name: event_log_id_seq; Type: SEQUENCE; Schema: audit; Owner: -
--
...
--
-- Name: event_log_id_seq; Type: SEQUENCE OWNED BY; Schema: audit; Owner: -
--
...
--
-- Name: admin_registrations_view; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW "public"."admin_registrations_view" AS
 SELECT "id",
    "registration_id",
    "title",
    "first_name",
...
--
-- Name: registrations_backup_yyyymmdd; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: access_log id; Type: DEFAULT; Schema: audit; Owner: -
--
...
--
-- Name: event_log id; Type: DEFAULT; Schema: audit; Owner: -
--
...
--
-- Name: event_log event_log_pkey; Type: CONSTRAINT; Schema: audit; Owner: -
--
...
--
-- Name: registrations registrations_registration_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_access_log_request_id; Type: INDEX; Schema: audit; Owner: -
--
...
--
-- Name: idx_event_log_action; Type: INDEX; Schema: audit; Owner: -
--
...
--
-- Name: idx_event_log_correlation_id; Type: INDEX; Schema: audit; Owner: -
--
...
--
-- Name: idx_event_log_occurred_at; Type: INDEX; Schema: audit; Owner: -
--
...
--
-- Name: idx_audit_admin_email; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_audit_registration_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_business_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_company_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_status_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_status_province; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_update_reason; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_registrations_yec_province; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ux_event_settings_singleton; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: registrations trigger_update_registration_status; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "trigger_update_registration_status" BEFORE UPDATE ON "public"."registrations" FOR EACH ROW EXECUTE FUNCTION "public"."update_registration_status"();
...
--
-- Name: access_log Authenticated users can access all audit logs; Type: POLICY; Schema: audit; Owner: -
--
...
--
-- Name: event_log Authenticated users can access all audit logs; Type: POLICY; Schema: audit; Owner: -
--
...
--
-- Name: access_log Service role can access all audit logs; Type: POLICY; Schema: audit; Owner: -
--
...
--
-- Name: event_log Service role can access all audit logs; Type: POLICY; Schema: audit; Owner: -
--
...
--
-- Name: access_log; Type: ROW SECURITY; Schema: audit; Owner: -
--

ALTER TABLE "audit"."access_log" ENABLE ROW LEVEL SECURITY;

--
-- Name: event_log; Type: ROW SECURITY; Schema: audit; Owner: -
--
...
--
-- Name: event_settings Admin users can insert event settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_settings Admin users can update event settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registrations Admin users can update registrations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registrations Admin users can view all registrations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_settings Admin users can view event settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registrations Allow Admin Read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registrations Allow Public Insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: admin_users Super admins can insert admin users; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: admin_users Super admins can view all admin users; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registrations Users can insert registrations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects Anonymous upload to chamber-cards; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Anonymous upload to chamber-cards" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'chamber-cards'::"text"));


--
-- Name: objects Anonymous upload to payment-slips; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Anonymous upload to payment-slips" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'payment-slips'::"text"));


--
-- Name: objects Anonymous upload to profile-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Anonymous upload to profile-images" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'profile-images'::"text"));
...
CREATE POLICY "Public read access" ON "storage"."objects" FOR SELECT USING (("bucket_id" = ANY (ARRAY['profile-images'::"text", 'chamber-cards'::"text", 'payment-slips'::"text"])));


--
-- Name: objects Public read access to yec-badges; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read access to yec-badges" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'yec-badges'::"text"));


--
-- Name: objects Service role upload to yec-badges; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Service role upload to yec-badges" ON "storage"."objects" FOR INSERT TO "service_role" WITH CHECK (("bucket_id" = 'yec-badges'::"text"));
...
\unrestrict gNnIAY8Nd0zDy5ifBIYNawa3PPvk6JzGA5cZgstQ7EdmKrOCJOEwuzxrDaZkTkf
