alter table "audit"."event_log" drop column "event_data";

alter table "audit"."event_log" drop column "event_type";

alter table "audit"."event_log" drop column "ip_address";

alter table "audit"."event_log" drop column "session_id";

alter table "audit"."event_log" drop column "user_agent";

alter table "audit"."event_log" drop column "user_id";

alter table "audit"."event_log" add column "action" text not null;

alter table "audit"."event_log" add column "actor_id" text;

alter table "audit"."event_log" add column "actor_role" text not null;

alter table "audit"."event_log" add column "correlation_id" text not null;

alter table "audit"."event_log" add column "meta" jsonb;

alter table "audit"."event_log" add column "reason" text;

alter table "audit"."event_log" add column "resource" text not null;

alter table "audit"."event_log" add column "resource_id" text;

alter table "audit"."event_log" add column "result" text not null;
