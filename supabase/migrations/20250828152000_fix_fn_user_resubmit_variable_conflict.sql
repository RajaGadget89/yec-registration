-- Migration: Fix fn_user_resubmit variable name conflict
-- Date: 2025-08-28
-- Purpose: Fix variable name conflict with column names in fn_user_resubmit function

-- Fix the fn_user_resubmit function to avoid variable name conflicts with column names
...
DO $$
BEGIN
    RAISE NOTICE 'Fixed fn_user_resubmit function variable name conflicts';
END $$;
