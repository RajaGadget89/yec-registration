...
alter table "public"."email_outbox" drop column "attempts";

alter table "public"."email_outbox" drop column "max_attempts";

alter table "public"."email_outbox" drop column "sent_at";
